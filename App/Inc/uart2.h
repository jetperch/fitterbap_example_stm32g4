...
#ifndef APP_STM32G4_UART2_H__
#define APP_STM32G4_UART2_H__
 ...
 */
typedef void (*uart2_recv_fn)(void *user_data, uint8_t *buffer, uint32_t buffer_size);
 ...
 * ensure that the subsequent call to uart2_send succeeds.
 */
