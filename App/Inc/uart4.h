...
#ifndef APP_STM32G4_UART4_H__
#define APP_STM32G4_UART4_H__
 ...
 */
typedef void (*uart4_recv_fn)(void *user_data, uint8_t *buffer, uint32_t buffer_size);
 ...
 * ensure that the subsequent call to uart4_send succeeds.
 */
